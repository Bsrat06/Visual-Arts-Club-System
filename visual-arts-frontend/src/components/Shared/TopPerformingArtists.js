...
const TopPerformingArtists = ({ artists }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-[475px] float-right">
            {/* Adjusted width */}
                        ...
                        <div className="flex items-center flex-1">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-gray-500">
                                    {artist.uploads} Posts • {artist.likes} Likes
                                </p>
                            </div>
                        </div>
                        <div className="text-4xl">{trophies[index]}</div>
                    </div>
                ))}
            </div>
        </div>
